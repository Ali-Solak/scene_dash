...
/// A trivial [Component] used to exercise [SceneNodeRef.component].
...
void main() {
  group('SceneNodeRef.component', () {
    ...
    test('returns null when no component of the type is attached', () {
      final ref = SceneNodeRef(Node()..addComponent(_OtherComponent()));
